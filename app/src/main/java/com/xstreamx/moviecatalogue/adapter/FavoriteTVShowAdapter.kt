...
class FavoriteTVShowAdapter(private val listItems: ArrayList<TvShow>, private val context: Context,
                            private val mListener: OnItemClicked)  : RecyclerView.Adapter<FavoriteTVShowAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvYear.text = item.releaseDate
